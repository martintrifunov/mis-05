...
class TableEventsExample extends StatefulWidget {
  ...
  const TableEventsExample(this.exams);

  @override
  _TableEventsExampleState createState() => _TableEventsExampleState(this.exams);
}
